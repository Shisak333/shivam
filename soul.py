...
TOKEN = '8088213516:AAEBgD2zFVFY9RA1xkneaC-8MwIWcRD5UFs'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002410640320
CHANNEL_ID = -1002410640320
error_channel_id = -1002410640320
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @SHIVAMXRAJ.*", parse_mode='Markdown')  # Contact owner message
            return
